    ...
    class transaction;
        ...
        bit tx;
            ...
            $display("%t, [%s] ran_data = %d, received_data = %d, tx = %d", $time, name_s, ran_data, received_data, tx);
        endtask 
    endclass
    ...
    class driver;
        ...
        function new(mailbox#(transaction)gen2drv_mbox, virtual uart_interface uart_intf);
            this.gen2drv_mbox = gen2drv_mbox;
    ...
    class monitor;
        ...
        function new(mailbox#(transaction)mon2scb_mbox, virtual uart_interface uart_intf);
        ...
        task run();
            ...
            forever begin
                ...
                #(BIT_PERIOD);
                tr.ran_data = uart_intf.ran_data;
                tr.display("[MON]");
                mon2scb_mbox.put(tr);
            end
